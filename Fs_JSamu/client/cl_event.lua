	...
	Citizen.CreateThread(function()
		...
		while timer > 0 and IsDead do
			...
			if IsControlPressed(0, Keys['E']) then
				-- ESX.ShowAdvancedNotification("Secours", "~b~Information", "Votre requête a bien été envoyée aux équipes nécessaires.", "CHAR_MICHAEL", 10)
				exports['okokNotify']:Alert("Secours", "Votre requête a bien été envoyée aux équipes nécessaires.", 5000, 'info')
...
AddEventHandler('esx_ambulancejob:notif', function()
	...
	ReaFaite = true
	-- ESX.ShowAdvancedNotification('Secours', 'Central', 'Réanimation effectué.\n~g~'..Nombreinter..' intervention en cours.', 'CHAR_MICHAEL', 3)
	exports['okokNotify']:Alert("Secours", "Réanimation effectué. "..Nombreinter.." intervention en cours.", 5000, 'success')
end)
...
function RemoveItemsAfterRPDeath()
	...
	Citizen.CreateThread(function()
		...
		exports['okokNotify']:Alert("Réanimation X", "Vous avez été réanimé par l\'unité X", 5000, 'success')
...
AddEventHandler('esx_ambulancejob:heal', function(healType, quiet)
	...
	if not quiet then
		...
		exports['okokNotify']:Alert("Titre", "Tu a été soigner", 5000, 'success')
	end
end)
