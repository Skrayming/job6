...
AddEventHandler('Ouvre:ambulance', function()
	...
	for i=1, #xPlayers, 1 do
		...
		TriggerClientEvent('okokNotify:Alert', xPlayers[i], "Hôpitaux de Paris", "Les médecins sont prêts à vous secourir !", 5000, 'neutral')
	end
end)
...
AddEventHandler('Ferme:ambulance', function()
	...
	for i=1, #xPlayers, 1 do
		...
		TriggerClientEvent('okokNotify:Alert', xPlayers[i], "Hôpitaux de Paris", "Plus aucun médecin est disponible en ville !", 5000, 'neutral')
	end
end)
...
RegisterCommand('amb', function(source, args, rawCommand)
    ...
    if xPlayer.job.name == "ambulance" then
        ...
        for i=1, #xPlayers, 1 do
			...
			TriggerClientEvent('okokNotify:Alert', xPlayers[i], "Hôpitaux de Paris", ""..msg.."", 5000, 'neutral')
        end
    else
...
AddEventHandler('esx_ambulancejob:revive', function(target)
	...
	if xPlayer.job.name == 'ambulance' or xPlayer.job.name == 'pompier' then
...
AddEventHandler('EMS:PriseAppelServeur', function()
	...
	for i = 1, #xPlayers, 1 do
		...
		if thePlayer.job.name == 'ambulance' or xPlayer.job.name == 'pompier' then 
			-- TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], 'Secours', '~b~Information', ''..name..'~s~ a pris l\'appel', 'CHAR_MICHAEL', 2)
			TriggerClientEvent('okokNotify:Alert', source, "Secours", ""..name.." a pris l\'appel", 5000, 'info')
